  ...
  return (
    ...
    >
            ...
            <div ref={newsletterSectionRef}>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 min-w-0 px-4 py-3 bg-white/5 border border-white/10 rounded-[30px] text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-neon-cyan/50"
                />
                <button
                  onClick={handleContactClick}
                  className="flex-shrink-0 px-4 py-3 bg-neon-cyan/20 text-neon-cyan rounded-[30px] text-sm font-medium hover:bg-neon-cyan/30 transition-colors whitespace-nowrap"
                >
      ...
      <NewsletterModal
        ...
        message={footerConfig.subscribeAlertMessage}
      />
    </section>
  );
};
